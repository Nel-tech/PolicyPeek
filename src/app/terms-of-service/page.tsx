...
export default function TermsOfService() {
    return (
        <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800 dark:text-gray-100">
            <h1 className="text-3xl font-montserrat font-bold mb-6 text-blue-600 dark:text-blue-400">
                Terms of Service
            </h1>

            <section className="mb-6">
                <h2 className="text-xl font-montserrat font-semibold mb-2">1. Introduction</h2>
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2 font-montserrat">2. Service Description</h2>
                <p className="text-gray-700 dark:text-gray-300 font-sans">
                ...
                <p className="mt-2 font-sans italic text-sm text-gray-600 dark:text-gray-400">
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2 font-montserrat">3. Acceptable Use</h2>
                <ul className="list-disc font-sans list-inside space-y-1 text-gray-700 dark:text-gray-300">
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2 font-montserrat">4. No Legal Advice</h2>
                <p className="text-gray-700 dark:text-gray-300 font-sans">
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2 font-montserrat">5. Termination</h2>
                <p className="text-gray-700 dark:text-gray-300 font-sans">
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2 font-montserrat">6. Changes to Terms</h2>
                <p className="text-gray-700 dark:text-gray-300 font-sans">
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2 font-montserrat">7. Governing Law</h2>
                <p className="text-gray-700 dark:text-gray-300 font-sans">
            ...
            {/* <section>
                <h2 className="text-xl font-semibold mb-2 font-montserrat">8. Contact</h2>
                <p className="text-gray-700 dark:text-gray-300 font-sans">
