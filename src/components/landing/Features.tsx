        ...
        <section className="bg-gray-50 dark:bg-[#0f0f0f] py-20 px-6 text-center">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-10 text-left">
                    <AnimatedCard
                        icon={
                            <FileSearchIcon className="h-10 w-10 text-blue-500 dark:text-blue-400 mb-4" />
                        }
                    ...
                    <AnimatedCard
                        icon={
                            <AlertTriangleIcon className="h-10 w-10 text-blue-500 dark:text-blue-400 mb-4" />
                        }
                        title="Risk Flags"
                    ...
                    <AnimatedCard
                        icon={
                            <ShieldCheckIcon className="h-10 w-10 text-blue-500 dark:text-blue-400 mb-4" />
                        }
